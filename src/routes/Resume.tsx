...
const Resume = () => {
    ...
    "- Willingness to learn." + newLine +
    "Thank you for taking the time to review my résumé. I look forward to talking with you." + newLine +
    "Sincerely," + newLine +
    "Nick Shockey";
    ...
    "## Want to learn more" + newLine +
    "Rust, C/C++, SQL, Bash" + newLine +
    "## Favorite dev tools" + newLine +
    "Visual Studio Code, Visual Studio, Notepad++, Neovim, Beekeeper Studio" + newLine +
